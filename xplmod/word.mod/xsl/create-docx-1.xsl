...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
  ...
  <xsl:variable name="xtpxlib-word-xml-document" as="element(xtlxo:document)" select="/*/xtlcon:document[@document-type eq 'xtpxlib-word-xml']/*"/>
  ...
  <xsl:template match="xtlxo:p" mode="mode-process-contents">
    <w:p>
  ...
  <xsl:template match="xtlxo:span" mode="mode-process-inline">
    <w:r>
